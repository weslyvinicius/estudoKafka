...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Message2> producerFactory() {
        return new DefaultKafkaProducerFactory(producerConfigs());
    }

    @Bean
    public KafkaTemplate<String, Message2> kafkaTemplate() {
    ...
    public NewTopic topicExample() {
        return TopicBuilder.name(Topics.MESSAGE2_TOPIC)
                .partitions(3)
                .replicas(1)
                .build();
    }
