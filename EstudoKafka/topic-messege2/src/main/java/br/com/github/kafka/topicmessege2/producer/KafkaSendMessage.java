package br.com.github.kafka.topicmessege2.producer;
...
public class KafkaSendMessage {
    ...
    public void sendMessageMessage2(Message2 message2) {
        ListenableFuture<SendResult<String, Message2>> future = kafkaTemplate.send(Topics.MESSAGE2_TOPIC, message2);
