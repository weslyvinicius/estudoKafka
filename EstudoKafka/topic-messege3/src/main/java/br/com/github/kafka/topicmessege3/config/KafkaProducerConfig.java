...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Message3> producerFactory() {
        return new DefaultKafkaProducerFactory(producerConfigs());
    }

    @Bean
    public KafkaTemplate<String, Message3> kafkaTemplate() {
    ...
    public NewTopic topicExample() {
        return TopicBuilder.name(Topics.MESSAGE3_TOPIC)
                .partitions(3)
                .replicas(1)
                .build();
    }
